...
(define s1  (stream-cons 1 the-empty-system))
(define s11  (stream-cons 11 the-empty-system))
(define s2  (stream-cons 22 (stream-cons 2 the-empty-system)))
(define s33  (stream-cons 33 (stream-cons 3 the-empty-system)))
